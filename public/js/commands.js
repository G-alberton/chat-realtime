export function handleCommand(input, { print, socket, setUsername }) {
    const [commands, ...args] = input.split("");

    switch (commands) {
        case "/help":
            print("Comandos disponiveis:", "system");
            print("/help - listar comandos", "system");
            print("/nick [nome] - definir nome", "system");
            print("/clear - limpa terminal", "system");
            print("/users - listar usuário online", "system");
            ...
            case "/msg":
                ...
                if (!to || !message) {
                    print("Uso: /msg [usuario] [message]", "system");
                    return;
                }
